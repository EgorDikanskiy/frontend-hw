...
const LoaderSvgL = () => {
    return (
        <svg className={styles.loader} width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const LoaderSvgM = () => {
    return (
        <svg className={styles.loader} width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const LoaderSvgS = () => {
    return (
        <svg className={styles.loader} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
